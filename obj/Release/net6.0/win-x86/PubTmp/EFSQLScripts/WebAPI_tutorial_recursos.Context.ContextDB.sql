...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230822045906_migracion')
BEGIN
...
BEGIN
    CREATE TABLE [Review] (
        ...
        CONSTRAINT [FK_Review_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]),
...
BEGIN
    ...
    VALUES (1, ''2023-08-22T01:59:05.8369863-03:00'', N''Gonzalo'', ''2023-08-22T01:59:05.8369886-03:00''),
    (2, ''2023-08-22T01:59:05.8369888-03:00'', N''Ramiro'', ''2023-08-22T01:59:05.8369889-03:00''),
    (3, ''2023-08-22T01:59:05.8369890-03:00'', N''Daniel'', ''2023-08-22T01:59:05.8369891-03:00''),
    (4, ''2023-08-22T01:59:05.8369892-03:00'', N''Gastón'', ''2023-08-22T01:59:05.8369892-03:00''),
    (5, ''2023-08-22T01:59:05.8369893-03:00'', N''Martín'', ''2023-08-22T01:59:05.8369894-03:00'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Creation', N'Name', N'Update') AND [object_id] = OBJECT_ID(N'[Author]'))
...
BEGIN
    ...
    VALUES (1, ''2023-08-22T01:59:05.8370151-03:00'', N''El libro de la selva'', ''2023-08-22T01:59:05.8370152-03:00''),
    (2, ''2023-08-22T01:59:05.8370153-03:00'', N''La vida de Steve Jobs'', ''2023-08-22T01:59:05.8370154-03:00'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Creation', N'Title', N'Update') AND [object_id] = OBJECT_ID(N'[Book]'))
...
BEGIN
    ...
    VALUES (N'20230822045906_migracion', N'7.0.10');
END;
GO
